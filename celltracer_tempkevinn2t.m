...
fname = ['K:\',...
    '2015-06-29-5eErkTR-TrkAwt-clonetest12.nd2']; 

     
%Save file name
sname = '2015-06-29-5eErkTR-TrkAwt-clonetest12';
...
bk(1).reg = [749, 221]; bk(1).dyn = false; bk(1).fix = true;
bk(2:115) = bk(1);
...
bkmd.exp.Exposure   =   [200, 300];        %Exposure times (ms)
bkmd.exp.ExVolt     =   [25, 36];           %Relative voltages used
bkmd.exp.Filter     =   {'Filter_DAPI' 'Filter_Cherry2'};
bkmd.exp.FPhore     =   {'DAPI', 'RFP'};
