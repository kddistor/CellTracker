...
op.cname = {'DAPI', 'RFP2'};       %Channel names
...
fname = ['K:\',...
    '2015-06-24-ErkTR-TrkA-clonetest.nd2']; 
% fname = ['G:\',...
%     '2015-05-19-5e-EKARFoxo-exosomes_crop.nd2']; 

     
%Save file name
sname = '2015-06-24-ErkTR-TrkA-clonetest';
% sname = 'K:\2015-05-19-5e-EKARFoxo-exosomes';
% sname = 'G:\2015-05-19-5e-EKARFoxo-exosomes_crop';
% 
...
bk(1).reg = [1474, 324]; bk(1).dyn = false; bk(1).fix = true;
bk(2:73) = bk(1);
...
bkmd.exp.Channel    =   {'DAPI', 'RFP2'};  %Name(s) of Channel(s)
bkmd.exp.Exposure   =   [200, 200];        %Exposure times (ms)
bkmd.exp.ExVolt     =   [45, 40];           %Relative voltages used
bkmd.exp.Filter     =   {'Filter_DAPI', 'Filter_Cherry2'};
bkmd.exp.FPhore     =   {'DAPI', 'mCherry'};
